...
Приложение покрыто комплексными тестами на всех уровнях:

### Типы тестов

1. **Модульные тесты (Unit Tests)** - Vitest + React Testing Library
   - Тесты утилит и вспомогательных функций
   - Изолированные тесты компонентов
   - Быстрое выполнение (<1s на тест)

2. **Интеграционные тесты** - MSW для мокирования API
   - Тестирование пользовательских сценариев
   - Интеграция компонентов с API
   - Проверка потоков данных

3. **E2E тесты (End-to-End)** - Playwright
   - Сквозные тесты бизнес-сценариев
   - Кросс-браузерное тестирование
   - Реальное взаимодействие с приложением

### Запуск тестов

```bash
npm test              # Все модульные и интеграционные тесты
npm run test:ui       # Интерактивный UI для тестов
npm run test:coverage # Отчет о покрытии кода
npm run test:e2e      # Все E2E тесты
npm run test:e2e:ui   # E2E тесты в интерактивном режиме
```

### Покрытие кода

Минимальные требования: 60% (lines, functions, branches, statements)
